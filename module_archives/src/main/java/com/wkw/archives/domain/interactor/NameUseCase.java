...
public class NameUseCase extends UseCase<String, Void> {


    private final ArchivesRepository mArchivesRepository;

    @Inject
    public NameUseCase(ArchivesRepository archivesRepository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    public Observable<String> buildUseCaseObservable(Void params) {
        return mArchivesRepository.fetchName();
    }
