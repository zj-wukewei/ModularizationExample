...
//        }
    ...
    public RecyclerViewWithFooter applyFailureText(CharSequence failureText) {
        mFootItem.failureText = failureText;
        return this;
    }
    ...
    public void setFailure(OnClickListener listener) {
        if(getAdapter() != null) {
            ...
            mFootItem.mRetryClick = listener;
            getAdapter().notifyItemChanged(getAdapter().getItemCount() - 1);
            getAdapter().notifyDataSetChanged();
        }
    }
    ...
    @IntDef({STATE_END, STATE_LOADING, STATE_EMPTY, STATE_NONE, STATE_PULL_TO_LOAD, STATE_FAILURE})
    ...
    public class LoadMoreAdapter extends Adapter<ViewHolder> {
        ...
        private class LoadMoreVH extends VH {
            ...
            public void onBindViewHolder() {
                ...
                if (mState == STATE_LOADING || mState == STATE_END || mState == STATE_PULL_TO_LOAD || mState == STATE_FAILURE) {
