...
public class ProgressLayout extends RelativeLayout {
    ...
    private void showFailedView(OnClickListener retryListener) {
        ...
        if (this.failedContainer == null) {
            ...
            try {
                failedTextView = (TextView) this.failedContainer.findViewById(R.id.textview_failed);
                setFailledText();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private void setFailledText() {
        if (StringUtils.isNotEmpty(mFailedText.toString()) && failedTextView != null) {
            failedTextView.setText(mFailedText);
        }
    }
