package com.wkw.uikit.tablayout;
...
/**
 * Created by hzwukewei on 2017-2-20.
 * <com.vongihealth.common.tablayout.SlidingTabLayout
 * android:id="@+id/toolbar_sliding_tab_layout"
 * android:layout_width="match_parent"
 * android:layout_height="match_parent"
 * android:layout_marginLeft="60dp"
 * android:layout_marginRight="60dp"
 * app:tl_indicator_color="@color/tl_indicator_color"
 * app:tl_indicator_height="3dp"
 * app:tl_indicator_width_equal_title="true"
 * app:tl_tab_space_equal="true"
 * app:tl_textSelectColor="@color/tl_textSelectColor"
 * app:tl_textUnselectColor="@color/tl_textUnselectColor"
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public void setUnReadView(int position, boolean isShow) {
        if (position < 0 || position > mTabCount - 1) {
            return;
        }
        View tabView = mTabsContainer.getChildAt(position);
        ImageView unReadImg = tabView.findViewById(R.id.img_tab_unread);
        if (unReadImg != null) {
            unReadImg.setVisibility(isShow ? VISIBLE : GONE);
        }
    }
